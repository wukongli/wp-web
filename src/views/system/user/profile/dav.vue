<template>
  ...
  <el-dialog title="提示" v-model="quarkShow" class="qr-dialog" @close="handleDialogClose">
    ...
    <template #footer>
      <el-button type="primary" @click="handleDialogClose" :loading="loading">生成webDav</el-button>
    </template>
  </el-dialog>
</template>
