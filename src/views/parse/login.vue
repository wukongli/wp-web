<template>
  <div class="login app-container">
    <el-form
        ...
        class="login-form"
    >
      <h3 v-if="getToken()" class="title">红头船小店<span style="color: red;">(赞助版)</span></h3>
      <h3 v-else class="title">红头船小店</h3>
...
<!--        </el-input>-->
        <div class="login-code">
          <a target="_blank" href="https://flowus.cn/share/c68e3c55-67e5-460f-b937-7727e0378a34?code=BCRWJL">点击查看使用说明</a>
